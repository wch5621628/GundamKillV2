CommonTranslationTable = {
	...
	["global_effect"] = "全局效果",
	["aoe"] = "AOE",
	["single_target_trick"] = "单目标战术",
	["multiple_target_trick"] = "多目标战术",
	["delayed_trick"] = "延时战术",
	["buff_card"] = "辅助伤害",
	["damage_spread"] = "伤害传导",
	["weapon"] = "武器",
	...
	["#AskForPeaches"] = "%from 向 %to 求救，一共需要 %arg 张【<font color=\"yellow\"><b>整备</b></font>】",
	["#ChooseKingdom"] = "%from 选择了 %arg 势力",
	["#NullificationDetails"] = "【<font color=\"yellow\"><b>战术瓦解</b></font>】的目标是 %from 对 %to 的战术【%arg】",
	...
	["$PasteCard"] = "%from 对 %to 使用延时战术 %card",
	...
	["#DelayedTrick"] = "%from 的延时战术【%arg】开始判定",
	...
	["#AnalepticBuff"] = "%from 使用【<font color=\"yellow\"><b>能量</b></font>】，对 %to 造成的伤害从 %arg 点增加至 %arg2 点",
